...
private:
	...
	std::vector<CModel*> m_SubmittedModelDisplayers;

	std::vector<CPatch*> m_VisiblePatchOccluders;
	std::vector<CModel*> m_VisibleModelOccluders;
	std::vector<CModel*> m_VisibleModelDisplayers;
